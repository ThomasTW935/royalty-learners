  ...
  <Mod.main>
    ...
    <h2>
      Registration! </h2>
        ...
        <TextField label='Student Name' color='Secondary' variant='outlined' />
        <br/>
        ...
        <br/>
        <TextField label='Student Level' color='Secondary' variant='outlined' />
        <br/>
        <TextField label='Parent/Guardian' color='Secondary' variant='outlined' />
        <br/>
